...
public class MainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button tourn = view.findViewById(R.id.tournaments);
        Button match = view.findViewById(R.id.matches);
        ...
        tourn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.thirdFrame, tournament);
                ft.commit();
            }
        });
        ...
        match.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FragmentTransaction ft= manager.beginTransaction();
                ft.replace(R.id.thirdFrame, matchDetail).commit();
            }
        });
